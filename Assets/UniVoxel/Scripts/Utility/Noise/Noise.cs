...
namespace UniVoxel.Utility
{
    public static class JobPerlin
    {
        ...
        public static double GetOctavePerlin2D(double2 pos, int octaves, double persistence, int repeat = -1)
        {
            ...
            {
                total += GetPerlinNoise2D(pos * frequency, repeat) * amplitude;
        ...
        public static double GetOctavePerlin3D(double3 pos, int octaves, double persistence, int repeat = -1)
        {
            double total = 0;
            double frequency = 1;
            double amplitude = 1;
            ...
            for (int i = 0; i < octaves; i++)
            {
                total += GetPerlinNoise3D(pos * frequency, repeat) * amplitude;
        ...
        static double GetPerlinNoise2D(double2 pos, int repeat = -1)
        {
            ...
            int aa, ab, ba, bb;
            aa = _permutation[_permutation[_permutation[xi] + yi]];
            ab = _permutation[_permutation[_permutation[xi] + Inc(yi, repeat)]];
            ba = _permutation[_permutation[_permutation[Inc(xi, repeat)] + yi]];
            bb = _permutation[_permutation[_permutation[Inc(xi, repeat)] + Inc(yi, repeat)]];
        ...
        static double GetPerlinNoise3D(double3 pos, int repeat = -1)
        {
            // If we have any repeat on, change the coordinates to their "local" repetitions
            if (repeat > 0)
            {
            ...
            aba = _permutation[_permutation[_permutation[xi] + Inc(yi, repeat)] + zi];
            aab = _permutation[_permutation[_permutation[xi] + yi] + Inc(zi, repeat)];
            abb = _permutation[_permutation[_permutation[xi] + Inc(yi, repeat)] + Inc(zi, repeat)];
            baa = _permutation[_permutation[_permutation[Inc(xi, repeat)] + yi] + zi];
            bba = _permutation[_permutation[_permutation[Inc(xi, repeat)] + Inc(yi, repeat)] + zi];
            bab = _permutation[_permutation[_permutation[Inc(xi, repeat)] + yi] + Inc(zi, repeat)];
            bbb = _permutation[_permutation[_permutation[Inc(xi, repeat)] + Inc(yi, repeat)] + Inc(zi, repeat)];
